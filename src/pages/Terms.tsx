          ...
          <div className="max-w-4xl mx-auto bg-gradient-to-r from-navy to-navy-light rounded-xl shadow-lg p-6 md:p-8 overflow-hidden">
            ...
            {isJapanese ? (
              ...
              <div className="space-y-6 text-white/90">
                <section>
                  <h2 className="text-xl font-semibold mb-3 text-white">規約への同意</h2>
                  <p>Affarahウェブサイト（以下「本サイト」といいます）へアクセスし、利用することにより、これらの利用規約に同意したものとみなされます。これらの規約に同意いただけない場合は、本サイトのご利用をお控えください。</p>
                </section>
                
                <section>
                  <h2 className="text-xl font-semibold mb-3 text-white">サイトの利用について</h2>
                  <p>本サイトは、法令に従い、第三者の権利を侵害したり、本サイトの利用や享受を妨げたりすることのない方法でのみご利用いただけます。</p>
                </section>
                
                <section>
                  <h2 className="text-xl font-semibold mb-3 text-white">物件情報について</h2>
                ...
                <section>
                  <h2 className="text-xl font-semibold mb-3 text-white">知的財産権</h2>
                ...
                <section>
                  <h2 className="text-xl font-semibold mb-3 text-white">プライバシー</h2>
                  <p>本サイトの利用には、当社のプライバシーポリシーも適用されます。プライバシーポリシーは、本利用規約の一部を構成します。</p>
                </section>
                
                <section>
                  <h2 className="text-xl font-semibold mb-3 text-white">免責事項</h2>
                ...
                <section>
                  <h2 className="text-xl font-semibold mb-3 text-white">準拠法および管轄裁判所</h2>
                  <p>本利用規約は、日本法に準拠し解釈されます。また、本利用規約に関連して生じる紛争は、東京地方裁判所を専属的な管轄裁判所とします。</p>
                </section>
                
                <section>
                  <h2 className="text-xl font-semibold mb-3 text-white">利用規約の変更</h2>
                  <p>Affarahは、いつでも本利用規約を変更する権利を有します。変更後の規約は本サイト上に掲載いたします。変更後も本サイトを利用された場合、変更後の利用規約に同意したものとみなされます。</p>
                </section>
                
                <section>
                  <h2 className="text-xl font-semibold mb-3 text-white">お問い合わせ先</h2>
              ...
              <div className="space-y-6 text-white/90">
                ...
                <section>
                  <h2 className="text-xl font-semibold mb-3 text-white">Use of the Site</h2>
                ...
                <section>
                  <h2 className="text-xl font-semibold mb-3 text-white">Property Listings</h2>
                ...
                <section>
                  <h2 className="text-xl font-semibold mb-3 text-white">Privacy</h2>
